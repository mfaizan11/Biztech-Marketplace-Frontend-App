...
import { User, Lock, Mail, Phone, Building2, Save, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen py-12 px-4" style={{ backgroundColor: '#F9FAFB' }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p style={{ color: '#6B7280' }}>Manage your account information and security</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm mb-6">
          ...
          <div className="p-6 border-b" style={{ borderColor: '#E5E7EB' }}>
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-full flex items-center justify-center" style={{ backgroundColor: '#2EC4B6' }}>
                <User className="w-8 h-8 text-white" />
              </div>
              <div>
                <h2 style={{ color: '#0D1B2A' }}>{user?.name}</h2>
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-xs px-3 py-1 rounded" style={{ backgroundColor: '#DBEAFE', color: '#1E40AF' }}>
          ...
          <div className="border-b" style={{ borderColor: '#E5E7EB' }}>
            <div className="flex gap-8 px-6">
              <button
                ...
                style={{
                  borderColor: activeTab === 'profile' ? '#2EC4B6' : 'transparent',
              ...
              <button
                ...
                style={{
                  borderColor: activeTab === 'password' ? '#2EC4B6' : 'transparent',
                ...
                <div className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <Building2 className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: '#9CA3AF' }} />
                        <input
                          type="text"
                  ...
                  {/* Success Message */}
                  {saveSuccess && (
                    <div className="p-4 rounded-lg flex items-center gap-2" style={{ backgroundColor: '#D1FAE5', color: '#065F46' }}>
              ...
              <form onSubmit={handlePasswordSubmit}>
                <div className="space-y-6 max-w-xl">
                  ...
                  <div className="border-t pt-6" style={{ borderColor: '#E5E7EB' }}>
                    <h4 className="mb-4" style={{ color: '#0D1B2A' }}>New Password</h4>
                    ...
                    <div className="mt-4 p-3 rounded" style={{ backgroundColor: '#F9FAFB' }}>
                      <p className="text-xs mb-2" style={{ color: '#6B7280' }}>Password must contain:</p>
